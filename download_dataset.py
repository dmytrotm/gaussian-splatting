...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="mipnerf360", choices=["mipnerf360", "mipnerf360_extra", "bilarf_data", "zipnerf", "zipnerf_undistorted"])
    parser.add_argument("--save_dir", type=str, default=os.getcwd() + "/data")
    args = parser.parse_args()

    downloader = DownloadData(dataset=args.dataset, save_dir=Path(args.save_dir))
    downloader.main()
